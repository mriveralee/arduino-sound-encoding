...
//Removes the multiplicative when encoding and sends this value to the arduino
void sendToArduino(int frequency) {
 //Write to the Arduino Port
 int adjFrequency = frequency/3;
 PORT.write(adjFrequency);
 println(adjFrequency);
 delay(10);
}
